...
# Antigravity port: status.py and the wrap reader scripts both live flat in
# .agent/scripts/ (the source split skills/status/scripts vs skills/wrap/scripts
# collapsed into one scripts dir). So the wrap scripts are siblings here.
WRAP_SCRIPTS_DIR = SCRIPT_DIR
