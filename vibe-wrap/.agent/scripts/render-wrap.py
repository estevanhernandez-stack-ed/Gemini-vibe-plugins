...
# Antigravity port: assets/ travels with the scripts under .agent/scripts/
# (source had skills/wrap/{scripts,assets}; the port collapses them so the
# render core and its template are siblings).
