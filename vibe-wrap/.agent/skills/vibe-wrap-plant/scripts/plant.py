...
# Antigravity port: vibe-wrap-plant/scripts -> vibe-wrap-plant -> skills -> .agent
# (the port plugin root). atomic-append lives in .agent/scripts/.
PLUGIN_ROOT = SCRIPT_DIR.parent.parent.parent
ATOMIC_APPEND = PLUGIN_ROOT / "scripts" / "atomic-append-jsonl.py"

DATA_DIR = Path.home() / ".gemini" / "antigravity" / "data" / PLUGIN_NAME / "breadcrumbs"
