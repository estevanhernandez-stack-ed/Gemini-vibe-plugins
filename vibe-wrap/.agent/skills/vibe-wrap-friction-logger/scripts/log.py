...
full entry to `~/.gemini/antigravity/data/vibe-wrap/friction.jsonl`.
...
# Antigravity port: vibe-wrap-friction-logger/scripts -> vibe-wrap-friction-logger
# -> skills -> .agent (the port plugin root). The atomic-append helper lives in
# .agent/scripts/ (collapsed from the source skills/wrap/scripts/).
...
TARGET_FILE = Path.home() / ".gemini" / "antigravity" / "data" / PLUGIN_NAME / "friction.jsonl"
