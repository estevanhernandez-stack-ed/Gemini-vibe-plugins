...
This document is for the agent only. It defines how you reason about the builder's work in /vibe-cartographer-reflect. Use these dimensions to structure your thinking, but your output is qualitative observations — what landed and what to tighten — not scores or grades.
...
- Did deepening rounds in /vibe-cartographer-spec catch issues that would have caused problems during /vibe-cartographer-build? Or did skipping them leave gaps?
