...
**If the plugin persists user data** (e.g., `~/.gemini/profiles/builder.json`), elevate Threat Model to Recommended and document what's stored, where, and how users can inspect or delete it.
